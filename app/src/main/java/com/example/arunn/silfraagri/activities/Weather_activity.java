package com.example.arunn.silfraagri.activities;
...
import  com.example.arunn.silfraagri.AlarmReceiver;
import com.example.arunn.silfraagri.Constants;
import com.example.arunn.silfraagri.adapters.ViewPagerAdapter;
import com.example.arunn.silfraagri.adapters.WeatherRecyclerAdapter;
import com.example.arunn.silfraagri.fragments.RecyclerViewFragment;
import com.example.arunn.silfraagri.models.Weather;
import com.example.arunn.silfraagri.tasks.GenericRequestTask;
import com.example.arunn.silfraagri.tasks.ParseResult;
import com.example.arunn.silfraagri.tasks.TaskOutput;
import com.example.arunn.silfraagri.utils.UnitConvertor;
import com.example.arunn.silfraagri.widgets.AbstractWidgetProvider;
import com.example.arunn.silfraagri.widgets.DashClockWeatherExtension;
...
public class Weather_activity extends AppCompatActivity implements LocationListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_map) {
            Intent intent = new Intent(Weather_activity.this, MapActivity.class);
            startActivity(intent);
        }
        if (id == R.id.action_graphs) {
            Intent intent = new Intent(Weather_activity.this, GraphActivity.class);
            startActivity(intent);
        }
